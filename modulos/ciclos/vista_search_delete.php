...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Borrar Ciclo</li>
    </ol>
</nav>

<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1><span class="material-symbols-outlined mr-2 text-danger" style="font-size:28px;">delete</span>Borrar Ciclo Escolar</h1>
        <p>Selecciona un ciclo escolar para eliminarlo definitivamente del sistema</p>
    </div>
</div>
...
<div class="card border-0 shadow-sm mb-4" style="border-radius:12px;">
    <div class="card-body">
        <div class="autocomplete-wrap" style="position:relative;">
            <input type="text" id="ciclo_search" class="form-control" placeholder="Escribe el nombre del ciclo para ELIMINAR..." autocomplete="off"
...
<div id="form_container" class="opacity-50" style="pointer-events: none;">
    <form id="delete_form" method="get" action="#">
        <div class="card border-0 shadow-sm border-danger mb-4" style="border-radius:12px;">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">Por favor verifica que la información mostrada corresponda al ciclo que deseas eliminar. Esta acción no se puede deshacer.</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="f_fecha_inicio" class="form-control" readonly style="border-radius:8px; background-color:#f8fafc;">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="small font-weight-bold">Fecha de Término</label>
                            <input type="text" id="f_fecha_fin" class="form-control" readonly style="border-radius:8px; background-color:#f8fafc;">
                        </div>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="d-flex justify-content-between mb-5">
            ...
            <button type="submit" class="btn btn-danger" onclick="return confirm('¿ESTÁS COMPLETAMENTE SEGURO de eliminar este Ciclo Escolar?');" style="border-radius:8px; padding:10px 30px; font-weight:600;">
...
$(document).ready(function() {
    ...
    $results.on('click', '.ac-item', function() {
        ...
        $('#delete_form').attr('action', '<?php echo BASE_URL; ?>ciclos/delete/' + id);
