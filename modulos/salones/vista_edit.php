...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h1><span class="material-symbols-outlined mr-2" style="font-size:28px;">edit</span>Editar Salón</h1>
        <p>Actualización de: <strong><?php echo e($datos['nombre']); ?></strong></p>
    </div>
</div>
    ...
    <div class="col-md-7">
        <div class="card border-0 shadow-sm" style="border-radius:12px;">
            <div class="card-header bg-white font-weight-bold pt-3 pb-2">
                ...
                Modificar Datos del Espacio
            </div>
            <div class="card-body">
                <form method="post" action="<?php echo BASE_URL; ?>salones/edit/<?php echo $datos['id_salon']; ?>" class="check-dirty">
                    <div class="row">
