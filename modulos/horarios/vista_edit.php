...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h1><span class="material-symbols-outlined mr-2" style="font-size:28px;">edit_calendar</span>Editar Clase</h1>
        <p>Modifique la programación de la asignatura</p>
    </div>
</div>
...
<?php if ($warnings): ?>
    <div class="alert alert-warning shadow-sm" style="border-radius:12px; border-left: 5px solid #ffa000;">
        <div class="d-flex align-items-center mb-2">
            ...
            <strong class="text-dark">Advertencias de Horario (Traslapes):</strong>
        </div>
        ...
        <div class="mt-3 p-2 shadow-sm" style="border-radius:8px; background: rgba(255,255,255,0.5);">
            <p class="small mb-2 font-weight-bold italic">¿Deseas aplicar los cambios a pesar de los conflictos?</p>
        </div>
    </div>
<?php endif; ?>
...
<div class="row">
    <div class="col-md-9">
        <div class="card border-0 shadow-sm" style="border-radius:12px;">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo BASE_URL; ?>horarios/edit/<?php echo $oferta['id_oferta']; ?>" class="check-dirty">
                    ...
                    <?php if ($warnings): ?>
                        <div class="custom-control custom-checkbox mb-4 p-3 bg-warning-light" style="border:1px dashed #ffa000; border-radius:8px; background:#fffbf0;">
                            ...
                            <label for="forzar" class="custom-control-label font-weight-bold text-dark" style="cursor:pointer;">
                                Sí, proceder con el guardado (ignorar traslapes)
                            </label>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="time" name="hora_inicio" class="form-control" value="<?php echo e(substr($datos['hora_inicio'], 0, 5)); ?>" required style="border-radius:8px;">
                        </div>
                        <div class="col-md-3 form-group">
                            ...
                            <input type="time" name="hora_fin" class="form-control" value="<?php echo e(substr($datos['hora_fin'], 0, 5)); ?>" required style="border-radius:8px;">
                        </div>
                    </div>
                    ...
                    <div class="mt-4 d-flex justify-content-between border-top pt-4">
                        ...
                        <button type="submit" class="btn btn-primary" style="background:#197fe6; border:none; border-radius:8px; padding:10px 40px; font-weight:600; box-shadow: 0 4px 6px rgba(25, 127, 230, 0.2);">
                            <span class="material-symbols-outlined mr-1" style="font-size:20px; vertical-align:middle;">save</span> Actualizar Cambios
                        </button>
                    </div>
                </form>
            </div>
