...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Borrar Grupo</li>
    </ol>
</nav>

<div class="page-header mb-4 d-flex justify-content-between align-items-center">
    <div>
        <h1><span class="material-symbols-outlined mr-2 text-danger" style="font-size:28px;">delete</span>Borrar Grupo</h1>
        <p>Selecciona un grupo para eliminarlo definitivamente</p>
    </div>
</div>
...
<div class="card border-0 shadow-sm mb-4" style="border-radius:12px;">
    <div class="card-body">
        <div class="autocomplete-wrap" style="position:relative;">
            <input type="text" id="grupo_search" class="form-control" placeholder="Escribe el grado, sección o ciclo para ELIMINAR..." autocomplete="off"
...
<div id="form_container" class="opacity-50" style="pointer-events: none;">
    <form id="delete_form" method="get" action="#">
        <div class="card border-0 shadow-sm border-danger mb-4" style="border-radius:12px;">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">Por favor verifica que la información mostrada corresponda al grupo que deseas eliminar. Esta acción no se puede deshacer.</p>
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" id="f_seccion" class="form-control" readonly style="border-radius:8px; background-color:#f8fafc;">
                    </div>
                    <div class="col-md-4 form-group">
                        <label class="small font-weight-bold">Turno</label>
                        <input type="text" id="f_turno" class="form-control" readonly style="border-radius:8px; background-color:#f8fafc;">
                    </div>
                </div>
                <div class="form-group">
                    <label class="small font-weight-bold">Ciclo Escolar (ID)</label>
                    <input type="text" id="f_ciclo" class="form-control" readonly style="border-radius:8px; background-color:#f8fafc;">
                </div>
            </div>
        </div>
        <div class="d-flex justify-content-between mb-5">
            <a href="<?php echo BASE_URL; ?>grupos" class="btn btn-outline-secondary" style="border-radius:8px; padding:10px 25px;">
                <span class="material-symbols-outlined mr-1" style="font-size:20px; vertical-align:middle;">arrow_back</span> Cancelar
            </a>
            <button type="submit" class="btn btn-danger" onclick="return confirm('¿ESTÁS COMPLETAMENTE SEGURO de eliminar este Grupo?');" style="border-radius:8px; padding:10px 30px; font-weight:600;">
...
$(document).ready(function() {
    ...
    $results.on('click', '.ac-item', function() {
        ...
        $('#delete_form').attr('action', '<?php echo BASE_URL; ?>grupos/delete/' + id);
