...
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1><span class="material-symbols-outlined mr-2 text-danger" style="font-size:28px;">delete</span>Borrar Usuario</h1>
        <p>Selecciona un usuario para eliminarlo definitivamente del sistema</p>
    </div>
</div>
...
<div class="card border-0 shadow-sm mb-4" style="border-radius:12px;">
    <div class="card-body">
        <div class="autocomplete-wrap" style="position:relative;">
            <input type="text" id="user_search" class="form-control" placeholder="Escribe el nombre de usuario para ELIMINAR..." autocomplete="off"
...
<div id="form_container" class="opacity-50" style="pointer-events: none;">
    <form id="delete_form" method="get" action="#">
        <div class="card border-0 shadow-sm border-danger mb-4" style="border-radius:12px;">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">Por favor verifica que la información mostrada corresponda al usuario que deseas eliminar. Esta acción revoca el acceso permanentemente y no se puede deshacer.</p>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label class="small font-weight-bold">Nombre de Usuario</label>
                        <input type="text" id="f_user" class="form-control" readonly style="border-radius:8px; background-color:#f8fafc;">
                    </div>
                    <div class="col-md-6 form-group">
        ...
        <div class="d-flex justify-content-between mb-5">
            <a href="<?php echo BASE_URL; ?>usuarios" class="btn btn-outline-secondary" style="border-radius:8px; padding:10px 25px;">
                <span class="material-symbols-outlined mr-1" style="font-size:20px; vertical-align:middle;">arrow_back</span> Cancelar
            </a>
            <button type="submit" class="btn btn-danger" onclick="return confirm('¿ESTÁS COMPLETAMENTE SEGURO de eliminar a este Usuario?');" style="border-radius:8px; padding:10px 30px; font-weight:600;">
...
$(document).ready(function() {
    ...
    $results.on('click', '.ac-item', function() {
        ...
        $('#f_estado').val(u.estado == 1 ? 'Activo' : 'Inactivo');
        $('#delete_form').attr('action', '<?php echo BASE_URL; ?>usuarios/delete/' + id);
